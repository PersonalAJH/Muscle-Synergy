...
*/
//lint -sem(xsens::SharedDataPointer::SharedDataPointer, custodial(1))
//lint -sem(xsens::SharedDataPointer::reset, custodial(1))
template <typename T>
...
*/
//lint -sem(xsens::ExplicitlySharedDataPointer::ExplicitlySharedDataPointer, custodial(1))
//lint -sem(xsens::ExplicitlySharedDataPointer::reset, custodial(1))
template <typename T>
...
/*! \brief A template class that contains a reference counted pointer
	...
	clone() function should be written for the SharedDataPointer class.
*/
//lint -sem(xsens::SharedPointer::SharedPointer, custodial(1))
//lint -sem(xsens::SharedPointer::reset, custodial(1))
template <typename T>
