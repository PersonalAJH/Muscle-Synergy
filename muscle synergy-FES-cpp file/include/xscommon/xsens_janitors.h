...
*/
//lint -sem(xsens::JanitorFree::JanitorFree, custodial(1))
template <class T>
class JanitorFree {
private:
	T* m_control;
...
/*! \brief Memory releasing janitor class
	...
	janitor leaves scope.
*/
//lint -sem(xsens::JanitorDelete::JanitorDelete, custodial(1))
template <class T>
class JanitorDelete {
private:
	T* m_control;
...
*/
//lint -sem(xsens::JanitorDeleteNull::JanitorDeleteNull, custodial(1))
template <class T>
...
/*! \brief Memory releasing janitor class
	...
	janitor leaves scope.
*/
//lint -sem(xsens::JanitorDeleteArray::JanitorDeleteArray, custodial(1))
template <class T>
